...
{
    logging = false;
    NSString *url = @"http://imlab.jp/~kkunze/stats";
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    if(logging){
        NSURL *url = [NSURL URLWithString:@"http://dev.imlab.jp/blanks"];
        //NSURL *url = [NSURL URLWithString:@"http://192.168.2.1:8000"];
        ...
        NSString *urls = @"http://192.168.2.1:8000";
